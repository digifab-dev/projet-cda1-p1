...
if (testimonialPrev && testimonialNext) {
    testimonialPrev.addEventListener('click', function () {
        let testimonialActive = document.getElementsByClassName('testimonial-display')[0];
        testimonialActive.removeAttribute('class');
        switch (testimonialActive.id) {
            case 'testimonial-1':
                document.getElementById('testimonial-3').setAttribute('class', 'testimonial-display');
                break;
            case 'testimonial-2':
                document.getElementById('testimonial-1').setAttribute('class', 'testimonial-display');
                break;
            case 'testimonial-3':
                document.getElementById('testimonial-2').setAttribute('class', 'testimonial-display');
                break;
        }
    });
...
if (productPrev && productNext) {
    productPrev.addEventListener('click', function () {
        ...
        switch (productActive.id) {
            case 'product-1':
                document.getElementById('product-4').setAttribute('class', 'product-display');
                break;
            case 'product-2':
                document.getElementById('product-1').setAttribute('class', 'product-display');
                break;
            case 'product-3':
                document.getElementById('product-2').setAttribute('class', 'product-display');
                break;
            case 'product-4':
                document.getElementById('product-3').setAttribute('class', 'product-display');
                break;
        }
    });
